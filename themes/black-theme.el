...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; `(org-agenda-deadline-today ((,class (:weight bold :foreground ,red))))
   ;; `(org-agenda-deadline-overdue ((,class (:weight bold :foreground ,blue))))
   ;; `(org-agenda-deadline-tomorrow ((,class (:weight bold :foreground ,orange))))
   ;; `(org-agenda-deadline-future ((,class (:weight bold :foreground ,red))))
   `(org-agenda-diary ((t (:foreground ,indianred))))
   ...
   `(org-upcoming-deadline ((,class (:foreground ,magenta))))
